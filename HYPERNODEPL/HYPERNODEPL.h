...
#ifndef hypernodePL_H_
#define hypernodePL_H_

#define hypernodePL_VERSION "0.9.4"
...
#define MAX_LITERAL_SIZE 100			// Maximum Length Of Literal In hypernodePL
#define TOKEN_LIST_SIZE 4096			// Maximum Number Of Tokens In hypernodePL Job - TODO: Finalize Size
...
#define MAX_SOURCE_SIZE 1024 * 512		// 512KB - Maximum Size Of Decoded hypernodePL Source Code
...
// Number / Location Of Unsigned Ints To Send To hypernode Node For Validation
...
// Token Type / Literal Value From hypernodePL Source Code
typedef struct {
	int token_id;
	EPL_TOKEN_TYPE type;
	char *literal;
...
// List Of All Tokens In hypernodePL Source Code
typedef struct {
	SOURCE_TOKEN *token;
	int num;
	int size;
